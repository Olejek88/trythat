...
/*
            this.props.userStore.changeUserPassword(user,
...
export default inject('userStore', 'authStore', 'countryStore', 'cityStore', 'imageStore', 'commonStore')(withRouter(Settings));
