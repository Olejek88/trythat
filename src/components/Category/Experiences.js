...
class Experiences extends React.Component {
    render() {
        return (
            <div className="pageframe_div_discovery layout_tiles last_pageframe partial_width layout_3-3-3"
                ...
                <h3 className="discovery_pageframe_button">
                    <a className="sg-text-transform primaryButton button" href="/" tabIndex="0">
                        <div className="title-container"><p className="title">Показать все впечатления категории</p>
                        </div>
                    </a></h3>
            </div>
        );
