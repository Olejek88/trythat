                  ...
                  <div className="why">
                      <ul>
                          <li>
                              ...
                              <p className="text">Окажитесь в крутой компании среди лучших и талантливых людей в области
                                  кулинарии, спорта, туризма, музыки, стиля и других направлений отдыха.</p>
                          </li>
                          <li>
                              <p className="subject">Бесплатно</p>
                              <p className="text">После подтверждения регистрации вы сможете настроить свое предложение
                                  уникальным образом и выделить его среди других. Мы всего лишь возьмем небольшую комиссию с каждого предложения.</p>
                          </li>
                          <li>
                              <p className="subject">Работайте с профи</p>
                              <p className="text">Наша опытная команда всегда поможет вам на всех этапах работы,
                                  чтобы предоставить нашим клиентам максимальный уровень удобства и информирования.</p>
                          </li>
                          <li>
                          ...
                          <li>
                              ...
                              <p className="text">Вы сможете гибко настроить свой график работы: устраивать квесты или
                                  экскурсии по ночам или в полнолуние или учить йоге на открытом воздухе рано утром. </p>
                          </li>
                          <li>
