                        ...
                        <div className="step123">
                            <ul>
                                <li className="sg-inline-top">
                                    <div className="number" style={{flex: '0.2'}}><img src={"images/step1.png"}
                                                                                       alt={"Шаг 1"}/>
                                    </div>
                                    <p className="text" style={{flex: '0.8'}}>Заполните свой профиль и создайте свой
                                        набор
                                        впечатлений и услуг, используя наши шаблоны.</p>
                                </li>
                                <li className="sg-inline-top">
                                    <div className="number" style={{flex: '0.2'}}><img src={"images/step2.png"}
                                                                                       alt={"Шаг 2"}/>
                                    </div>
                                    <p className="text" style={{flex: '0.8'}}>Мы проверим Ваш профиль, свяжемся с Вами и
                                        если
                                        все в порядке, то начнем сотрудничать.</p>
                                </li>
                                <li className="sg-inline-top">
                                    <div className="number" style={{flex: '0.2'}}><img src={"images/step3.png"}
                                                                                       alt={"Шаг 3"}/>
                                    </div>
                                ...
                                <li className="sg-inline-top">
                                    <div className="number" style={{flex: '0.2'}}><img src={"images/step4.png"}
                                                                                       alt={"Шаг 4"}/>
                                    </div>
