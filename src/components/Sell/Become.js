          ...
          <div className="band">
              ...
              <div className="center" style={{width: '100%', minWidth: '960px'}}>
                  <div className="talents">
                      <ul>
                          <li className="offer">
                              <p className={"p-offer"}>От уроков игры в теннис до хоккейных тренировок с звездами КХЛ</p></li>
                          <li className="offer">
                              <p className={"p-offer"}>От известных поваров солидных ресторанов до влюбленных в кухню самоучек, обучающих у себя на дому</p></li>
                          <li className="offer">
                              <p className={"p-offer"}>От экскурсий на местные пивоварни до посещения малоизвестных музеев с местными гидами</p></li>
                      </ul>
                  </div>
              </div>
          </div>
