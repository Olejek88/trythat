                    ...
                    <table className="elements-list">
                        ...
                        <tr>
                            <td>
                                ...
                                <div style={{padding: '0 60px 0 60px'}}>Обозначьте время года, дни недели, даты и время
                                    услуги.
                            ...
                            <td>
                                ...
                                <div style={{padding: '0 60px 0 60px'}}>
                                    Чудесно проведите время. Мы предложим вам новые впечатления, на базе понравившихся
                                    Вам
                                </div>
                                <p></p>
                            </td>
