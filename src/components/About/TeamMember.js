        ...
        <React.Fragment>
            ...
            <div id="member_detail_1" className="team_member_div team_member_div_1 desktop">
                ...
                <div className="member_details"><p>
                    ...
                    вычислительной системы учета для жилых зданий и сооружений, разработка алгоритмов расчета
                    потребления.<br/>
                    ...
                    - разработка проекта на базе SCADA DeltaV для установки поверки расходомеров УПА-2000 ПГ
                    Метран.<br/>
